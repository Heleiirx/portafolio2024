    ...
    return(
        <div className="h-screen relative pt-20 h-screen flex flex-col items-center">
            <div className="relative flex flex-col pr-10 gap-4 w-screen">
                ...
                <article className="text-right w-3/4 lg:w-1/3 self-end font-mono text-lg lg:text-xl">Aplicación web de streaming que reune videos de youtube en una API rest diseñada con Json-Server, permite añadir videos, eliminarlos y editar la información añadida.</article>

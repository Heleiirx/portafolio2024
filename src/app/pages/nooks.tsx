    ...
    return(
        <div className="h-screen relative pt-20 h-screen flex flex-col items-center">
            <div className="relative flex flex-col pr-10 gap-4 w-screen">
                ...
                <article className="text-right w-3/4 lg:w-1/3 self-end font-mono text-lg lg:text-xl">{nooks.description}</article>
                <ProyectLinks page={nooks.pageURL} repo={nooks.repoURL} bgcolor={primaryColor} className="justify-evenly w-screen lg:w-1/3 lg:self-end" />
            </div>
            <div className="flex w-5/6 justify-center gap-2 mt-16 lg:translate-y-1/2">
            ...
            <div className="absolute flex flex-col-reverse gap-4 h-fill items-center bottom-14 bg-background py-4 lg:w-screen lg:bg-transparent lg:bottom-0 lg:py-0 lg:h-fit">
                <ProyectColors colors={colores} primaryColor={primaryColor} classNameParent="gap-4 self-end lg:pr-44 lg:-translate-y-20"/>
                <ProyectSkills  skills={nooks.skills} bgcolor={primaryColor} className="mx-5 my-4 gap-4 lg:self-start lg:pl-24 lg:w-1/2" />
            </div>
        </div>
    );
};
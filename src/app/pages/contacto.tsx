    ...
    return (
        <div className='h-screen flex flex-col justify-center items-start gap-6 ms-36' ref={ref} id={id}>
            ...
            <div className="flex gap-8 ">
                <button className='border border-primary py-2 px-4 rounded bg-primary text-white tracking-wider font-mono font-bold' onClick={() => window.open(gmailHref, '_blank')}>Say Hello</button>

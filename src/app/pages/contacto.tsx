...
export default function Contacto(){
    ...
    return(
        <div ref={scope} className="relative h-screen flex justify-center items-start pt-60 lg:pt-40">
            <div>
                <IoMdStar className='absolute text-2xl left-12 top-52 z-10 text-4xl star'/>
                <IoMdStar className='absolute text-xl left-14 top-64 z-10 text-4xl'/>
                <IoMdStarOutline className='absolute text-2xl right-14 top-64 z-10 text-4xl' />
            </div>

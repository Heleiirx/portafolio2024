...
export default function Nooks(){
    ...
    return(<>
     <XCarousel imagenesArr={NooksArr} direccion className="-rotate-12 -translate-y-4 lg:-translate-x-1/4 relative" ></XCarousel>
     <XCarousel imagenesArr={NooksArr} className="-rotate-12 lg:-translate-x-1/2 absolute" ></XCarousel>
    <div className="h-screen relative h-screen flex flex-col items-center overflow-y-hidden">
        ...
        <div className="absolute flex flex-col-reverse gap-4 h-fill items-center bottom-14 bg-background py-4 lg:flex-row-reverse lg:items-center lg:w-screen lg:justify-evenly lg:bottom-1/3 lg:py-0 lg:h-fit">

    ...
    return(
        <div className="w-full h-full flex flex-col lg:flex-row py-4 px-6 lg:px-12 gap-4">
            <div className="w-full lg:w-2/5 min-h-20 flex flex-col gap-1 p-4">
                ...
                {kairo.type === 'personal' ?  <h5 className="text-md font-bold" >{t('projects.personalProject')}</h5> : <h5 className="text-md font-bold" >{t('projects.teamProject')}</h5>} 
                <p className="text-sm font-mono">{typeof kairo.description === 'object'? kairo.description[language] : kairo.description}</p>

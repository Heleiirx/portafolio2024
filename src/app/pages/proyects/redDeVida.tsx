        ...
        <div className="w-full h-full flex flex-col py-4 px-6 lg:px-12 gap-4">
            ...
            <div className="w-screen min-h-20 flex gap-1 lg:pe-36 lg:pt-24 relative justify-end">
                <div className="w-1/2 flex flex-col gap-1 p-4">
                    ...
                    {redDeVida.type === 'personal' ?  <h5 className="text-md font-bold self-end text-end" >{t('projects.personalProject')}</h5> : <h5 className="text-md font-bold self-end text-right" >{t('projects.teamProject')}</h5>} 
                    <p className="text-sm font-mono self-end text-end lg:w-3/4">{typeof redDeVida.description === 'object' ? redDeVida.description[language] : redDeVida.description}</p>
